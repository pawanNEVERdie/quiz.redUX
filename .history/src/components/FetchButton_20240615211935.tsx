...
function FetchButton(props) {
  ...
  const handleFetch = async () => {
    ...
    try {
      ...
      // Here you would typically dispatch an action to update your Redux state with the fetched data
      console.log(data); // Placeholder: log the data for demonstration
    } catch (error) {
